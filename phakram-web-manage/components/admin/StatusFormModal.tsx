...
interface StatusFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: { name_th: string; name_en: string; is_active: boolean }) => void;
  status?: Status | null;
  mode: 'create' | 'edit';
}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h3 className="text-xl font-semibold text-gray-900">
              {mode === 'create' ? 'เพิ่มสถานะใหม่' : 'แก้ไขสถานะ'}
            </h3>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              >
                ชื่อสถานะ (ไทย) <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                id="name_th"
                ...
                placeholder="เช่น ใช้งาน, ไม่ใช้งาน"
              />
            </div>
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-700 mb-2"
              >
                ชื่อสถานะ (อังกฤษ) <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                id="name_en"
